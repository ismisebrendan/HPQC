...
def get_params(extension_in='csv', extension_out='gif'):
    """This function reads the input filename and output filename from
    the system arguments and captures some of the most common errors.
    It does not cover more subtle errors that a user might cause.
    Args:
        extension_in (string): a string containing the extension for the
            type of input file that is sought. Default = 'csv'
