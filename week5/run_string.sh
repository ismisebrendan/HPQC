...
# Test for 20 to 1000 points (steps of 10)
for i in {20..1000..10}; do
	# Test for 10 to 1000 cycles
	for j in {10..1000..10}; do
		# Test for 10 to 500 samples
		for k in {10..500..10}; do
