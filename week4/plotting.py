...
for i in range(2, 17):
    ...
    print(f'Mean time to send: {np.mean(Bsend_send[:,2])}, std = {np.std(Bsend_send[:,2])}')
    print(f'Mean time to receive: {np.mean(Bsend_recv[:,2])}, std = {np.std(Bsend_recv[:,2])}')
...
for i in range(2, 17):
    ...
    print(f'Mean time to send: {np.mean(Isend_send[:,2])}, std = {np.std(Isend_send[:,2])}')
    print(f'Mean time to receive: {np.mean(Isend_recv[:,2])}, std = {np.std(Isend_recv[:,2])}')
...
for i in range(2, 17):
    ...
    print(f'Mean time to send: {np.mean(Rsend_send[:,2])}, std = {np.std(Rsend_send[:,2])}')
    print(f'Mean time to receive: {np.mean(Rsend_recv[:,2])}, std = {np.std(Rsend_recv[:,2])}')
...
for i in range(2, 17):
    ...
    print(f'Mean time to send: {np.mean(Ssend_send[:,2])}, std = {np.std(Ssend_send[:,2])}')
    print(f'Mean time to receive: {np.mean(Ssend_recv[:,2])}, std = {np.std(Ssend_recv[:,2])}')
